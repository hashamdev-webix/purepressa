...
export const FinalBundlesCTA = ({ onShopBundles, onBuildPack }) => {
  const { final } = bundlesContent;
      ...
      <Container>
        <div className="relative z-10 mx-auto max-w-4xl space-y-8 text-center">
          ...
          <div className="flex flex-col justify-center gap-3 sm:flex-row sm:flex-wrap">
            <Button onClick={onShopBundles} size="lg">
              <Package className="h-5 w-5" />
              Shop Bundles
            </Button>
            <Button onClick={onBuildPack} size="lg" variant="outline">
              Build Your Pack
