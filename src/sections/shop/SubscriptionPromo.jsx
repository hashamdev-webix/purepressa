...
import { shopContent, subscriptionBenefits } from "@/data/shop";

export const SubscriptionPromo = () => {
  const { subscription } = shopContent;

  return (
    <Section className="bg-cream">
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="order-2 rounded-lg border border-border bg-surface p-8 shadow-soft lg:order-1 md:p-10">
